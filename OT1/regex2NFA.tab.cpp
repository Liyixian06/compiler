...
{
  "$end", "error", "$undefined", "CHAR", "OR", "STAR", "LPAREN", "RPAREN",
  "$accept", "lines", "concat", "basic", YY_NULLPTR
};
#endif
...
{
       9,     7,    10,     1,     6,     8,     2,     8,     9,     0,
      11,     0,    12
};

static const yytype_int8 yycheck[] =
{
       4,     0,     5,     3,     2,     4,     6,     4,    12,    -1,
       7,    -1,     8
};
...
yyreduce:
  ...
  case 2:
#line 68 "regex2NFA.y"
                            { (yyval.nfaval) = unionNFA((yyvsp[-2].nfaval),(yyvsp[0].nfaval)); myNFA = (yyval.nfaval);}
#line 1357 "regex2NFA.tab.cpp"
    break;

  case 3:
#line 69 "regex2NFA.y"
                   { (yyval.nfaval) = (yyvsp[0].nfaval); myNFA = (yyval.nfaval);}
#line 1363 "regex2NFA.tab.cpp"
    break;

  case 4:
#line 72 "regex2NFA.y"
                            { (yyval.nfaval) = concatNFA((yyvsp[-1].nfaval),(yyvsp[0].nfaval)); }
#line 1369 "regex2NFA.tab.cpp"
    break;

  case 5:
#line 73 "regex2NFA.y"
                    { (yyval.nfaval) = (yyvsp[0].nfaval); }
#line 1375 "regex2NFA.tab.cpp"
    break;

  case 6:
#line 76 "regex2NFA.y"
                        { (yyval.nfaval) = closureNFA((yyvsp[-1].nfaval)); }
#line 1381 "regex2NFA.tab.cpp"
    break;

  case 7:
#line 77 "regex2NFA.y"
                    { (yyval.nfaval) = fromsymbol((yyvsp[0].charval)); }
#line 1387 "regex2NFA.tab.cpp"
    break;

  case 8:
#line 78 "regex2NFA.y"
                                { (yyval.nfaval) = (yyvsp[-1].nfaval); }
#line 1393 "regex2NFA.tab.cpp"
    break;


#line 1397 "regex2NFA.tab.cpp"
